...
module.exports = "<div class=\"row\">\n  <div class=\"col-2\">\n    <a class=\"w-75 btn btn-block btn-outline-light btn-sm\" [routerLink]=\"['/campaigns/' + curr]\">\n      <i class=\"fas fa-chevron-left\"></i> Regresar\n    </a>\n  </div>\n</div>\n<div class=\"row\">\n  <div class=\"col-12\">\n    <h5 class=\"text-center text-light\">Nueva campaña</h5>\n  </div>\n</div>\n\n<form [formGroup]=\"form\" (submit)=\"save()\">\n  <div class=\"row my-2 text-light\">\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Fecha</label>\n        <input type=\"date\" class=\"form-control form-control-sm bg-dark text-light\" [min]=\"now()\" formControlName=\"date\">\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['date'].errors?.required\">\n          ¿Qué día iremos?\n        </span>\n      </div>\n    </div>\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Hora</label>\n        <input type=\"time\" class=\"form-control form-control-sm bg-dark text-light\" formControlName=\"time\">\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['time'].errors?.required\">\n          ¿A que horá es el evento?\n        </span>\n      </div>\n    </div>\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Asistentes</label>\n        <select class=\"form-control form-control-sm bg-dark text-light\" multiple formControlName=\"employees\">\n          <option *ngFor=\"let user of users\" [value]=\"user._id\">{{ user.name }} {{ user.last_name }}</option>\n        </select>\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['employees'].errors?.required\">\n          Esto no se atenderá solo...\n        </span>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row my-2 text-light\">\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Empresa</label>\n        <select #c class=\"form-control form-control-sm bg-dark text-light\" (change)=\"companyName = c.options[ c.selectedIndex ].text\"\n        formControlName=\"company\">\n          <option selected disabled value=\"0\">Selecciona una empresa</option>\n          <option *ngFor=\"let company of companies\" [value]=\"company._id\">{{ company.name }}</option>\n        </select>\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['company'].value == 0\">\n          Dime dónde será el evento\n        </span>\n      </div>\n    </div>\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Tipo de pago</label>\n        <select class=\"form-control form-control-sm bg-dark text-light\" formControlName=\"type\">\n          <option selected disabled value=\"0\">Selecciona un tipo</option>\n          <option value=\"nomina\">Nómina</option>\n          <option value=\"credito\">Crédito directo</option>\n        </select>\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['type'].value == 0\">\n          ¿Cómo se piensa cobrar?\n        </span>\n      </div>\n    </div>\n    <div class=\"col-sm-4\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Empleados aproximados</label>\n        <input type=\"text\" class=\"form-control form-control-sm bg-dark text-light\" formControlName=\"aprox_costumers\"\n          placeholder=\"Empleados aproximados\">\n        <span class=\"fs06 text-danger\" *ngIf=\"touched && form.controls['aprox_costumers'].errors?.pattern\">\n          No parece un número\n        </span>\n      </div>\n\n    </div>\n  </div>\n\n  <div class=\"row my-2 text-light\">\n    <div class=\"col-sm-6 offset-sm-3\">\n      <div class=\"form-group\">\n        <label class=\"fs08\">Comentarios adicionales</label>\n        <textarea class=\"form-control form-control-sm bg-dark text-light\" formControlName=\"comments\"\n          placeholder=\"Agrega comentarios\"></textarea>\n      </div>\n    </div>\n  </div>\n  <div class=\"row my-2 text-light\">\n    <div class=\"col-sm-6 offset-sm-3\">\n      <button type=\"submit\" class=\"btn btn-block btn-outline-light btn-sm\">Guardar</button>\n    </div>\n  </div>\n</form>\n"
...
var CampaignsComponent = /** @class */ (function () {
    function CampaignsComponent(ROUTE, CAMPAIGN_SERVICE, TOSTADOR) {
        this.ROUTE = ROUTE;
    ...
    CampaignsComponent.prototype.fetchCampaigns = function (name) {
        var _this = this;
        this.CAMPAIGN_SERVICE.fetch(this.curr, 8, name)
            ...
            _this.showing = _this.campaigns.length < 8 ? _this.count : (_this.campaigns.length * _this.curr);
        }, function (err) { return _this.TOSTADOR.error(err.message, '¡Error!'); }).add(function () { });
    };
    CampaignsComponent.prototype.findCompany = function (input) {
        var _this = this;
        ...
        this.timer = setTimeout(function () {
            ...
            if (input.length === 0) {
                ...
                _this.fetchCampaigns(input);
            }
        }, 500);
    };
    CampaignsComponent.prototype.clearTime = function () {
        clearTimeout(this.timer);
    };
...
var EditComponent = /** @class */ (function () {
    function EditComponent(ROUTE, ROUTER, TOSTADOR, USER_SERVICE, COMPANY_SERVICE, STORAGE_SERVICE, CAMPAIGN_SERVICE) {
        this.ROUTE = ROUTE;
        this.ROUTER = ROUTER;
        this.TOSTADOR = TOSTADOR;
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        if (name) {
            this.CAMPAIGN_SERVICE.fetch(0, 1, name)
                .subscribe(function (res) {
                _this.campaign = res.data[0];
                var x = 0;
                _this.campaign.modification = _this.campaign.modification.reverse();
                for (var i = 0; i < _this.campaign.modification.length; i += 3) {
                    _this.pagComments[x] = _this.campaign.modification.slice(i, (3 + i));
                    x++;
                }
            }, function (err) { return _this.TOSTADOR.error(err.message, '¡Error!'); }).add(function () {
                _this.createForm();
                _this.USER_SERVICE.catalog()
                    .subscribe(function (res) { return _this.users = res.data; }, function (err) { return _this.TOSTADOR.error(err.message, '¡Error!'); }).add(function () { });
                _this.COMPANY_SERVICE.catalog()
                    .subscribe(function (res) { return _this.companies = res.data; }, function (err) { return _this.TOSTADOR.error(err.message, '¡Error!'); }).add(function () { });
            });
        }
    };
    EditComponent.prototype.createForm = function () {
        var employees = this.campaign.employees.map(function (e) { return e._id; });
        var d = new Date(this.campaign.date);
        var date = d.getFullYear() + "-" + this.addZero(d.getMonth() + 1) + "-" + this.addZero(d.getDate());
        var time = this.addZero(d.getHours()) + ":" + d.getMinutes();
    ...
    EditComponent.prototype.now = function () {
        var date = new Date();
        return date.getFullYear() + "-" + this.addZero(date.getMonth() + 1) + "-" + this.addZero(date.getDate());
    };
    EditComponent.prototype.addZero = function (value) {
    ...
    EditComponent.prototype.save = function () {
        ...
        if (this.form.status === 'VALID') {
            ...
            this.CAMPAIGN_SERVICE.edit(this.campaign._id, data)
                .subscribe(function () { return _this.ROUTER.navigateByUrl('/campaigns/' + _this.curr); }, function (err) { return _this.TOSTADOR.error(err.message, '¡Error!'); }).add(function () { });
        }
    };
...
var NewComponent = /** @class */ (function () {
    function NewComponent(ROUTE, ROUTER, TOSTADOR, USER_SERVICE, COMPANY_SERVICE, STORAGE_SERVICE, CAMPAIGN_SERVICE) {
        this.ROUTE = ROUTE;
        this.ROUTER = ROUTER;
        this.TOSTADOR = TOSTADOR;
        this.USER_SERVICE = USER_SERVICE;
    ...
    NewComponent.prototype.now = function () {
        var date = new Date();
        return date.getFullYear() + "-" + this.addZero(date.getMonth() + 1) + "-" + this.addZero(date.getDate());
    };
    NewComponent.prototype.addZero = function (value) {
        return value < 10 ? "0" + value : value;
    };
...
var CampaignService = /** @class */ (function () {
    function CampaignService(cHttp) {
        this.cHttp = cHttp;
        this.route = 'campaign';
    }
