...
var EditComponent = /** @class */ (function () {
    function EditComponent(route, router, brandService, modelService, tostador, glassesService) {
        this.route = route;
        this.router = router;
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        if (name) {
            this.glassesService.fetch(0, 1, name)
                .subscribe(function (res) { return _this.glass = res.data[0]; }, function (err) { return _this.tostador.error(err.message, '¡Error!'); }).add(function () { });
        }
    };
...
var NewComponent = /** @class */ (function () {
    ...
    NewComponent.prototype.findModels = function () {
        var _this = this;
        var brand = this.form.controls.brand.value;
        if (brand) {
            this.modelService.findByBrand(brand)
                .subscribe(function (res) { return _this.models = res.data; }, function (err) { return _this.tostador.error(err.message, '¡Error!'); }).add(function () { });
        }
    };
