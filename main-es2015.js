...
let AuthGuard = class AuthGuard {
    constructor(cLogin, cRouter, cLs) {
        this.cLogin = cLogin;
    ...
    canActivate() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), 
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(() => {
            this.cLs.deleteData();
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(this.cRouter.createUrlTree(['/login']));
        }));
    }
};
